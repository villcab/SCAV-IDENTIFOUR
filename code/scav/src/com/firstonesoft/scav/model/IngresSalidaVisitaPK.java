...
/**
 * The primary key class for the ingres_salida_visita database table.
 * 
 */
@Embeddable
public class IngresSalidaVisitaPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof IngresSalidaVisitaPK)) {
			return false;
		}
		IngresSalidaVisitaPK castOther = (IngresSalidaVisitaPK)other;
		return 
